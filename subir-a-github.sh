#!/bin/bash
# Script para subir el proyecto a GitHub Pages (entrada: migration-path-planning.html)

cd "/Users/alejandrosilva/Documents/ascend-migration path planning"
...
# Commit
git commit -m "ASCEND Migration Path Planning mock"
